  ...
  <div class="w-full max-w-sm font-mono text-sm text-base-content msg-in">
    ...
    >
      <div class="flex flex-col gap-2">
        <label for="password" class="text-[11px] uppercase tracking-[0.18em] text-base-content/50"
          >password</label
        >
        <div class="relative">
          <svg
            class="absolute left-0 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-base-content/25 pointer-events-none"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            stroke-width="2"
